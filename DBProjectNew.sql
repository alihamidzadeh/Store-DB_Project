CREATE DATABASE  IF NOT EXISTS `storeproject` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci */;
USE `storeproject`;
...
(5,'2021-02-09 00:00:00','1000000',1),
(7,'2021-02-09 00:00:00','1000000',1),
(8,'2021-03-12 00:00:00','500000',2),
(9,'2021-03-22 00:00:00','18000',3);
...
(1,'mashhad','iran','38840918','9178176337','hashemieh20','9178178778',3),
(2,'tehran','iran','78900345','986543212','zaferanieh','123456789',1),
(3,'shiraz','iran','91567887','234987765','emamat','123123897',2);
...
(1,'comment about item','2002-02-02 00:00:00','good',1,1,3),
(2,'comment about item','2002-02-10 00:00:00','not bad',2,2,1),
(3,'comment about item','2002-02-10 00:00:00','ok',3,3,2),
(4,'comment about item','2002-02-20 00:00:00','awful',4,4,0),
(5,'comment about item','2002-02-12 00:00:00','good',5,1,3);
...
INSERT INTO `item_is_favorite_of_customer` VALUES
(1,1,'school'),
(2,2,'electronics'),
(4,3,'wearing');
...
(1,'notification about item','*****','2009-09-09 00:00:00','staff',1,1),
(2,'notification about various item','*****','2009-09-15 00:00:00','staff',3,4),
(3,'notification about dept','*****','2009-12-09 00:00:00','custemor',4,2);
...
(1,'start',10,'2022-04-06 00:00:00','2022-04-06 00:00:00','caps'),
(2,'site',12,'2022-06-12 00:00:00','2022-06-18 00:00:00','aaaa'),
(3,'CODE',8,'2022-08-08 00:00:00','2022-08-18 00:00:00','wwwww');
...
INSERT INTO `offers_has_item` VALUES
(2,2);
...
(1,1000000,'2021-02-09 00:00:00',222222,'Submitted',1,1,1),
(2,500000,'2021-03-12 00:00:00',2300,'Done',2,2,2),
(3,18000,'2021-03-22 00:00:00',11000,'In progress',3,3,3);
...
INSERT INTO `order_has_item` VALUES
(1,1,2),
(2,2,1),
(3,3,3);
...
('2021-02-09 00:00:00',600,1),
('2021-02-11 00:00:00',220000,2),
('2021-02-12 00:00:00',500,1),
('2021-02-16 00:00:00',500000,2),
('2021-03-19 00:00:00',12200,3),
('2021-03-21 00:00:00',400,4),
('2021-03-27 00:00:00',6000,3);
...
INSERT INTO `supplier_sends_to_warehouse` VALUES
(1,1),
(3,2),
(5,3);
...
INSERT INTO `supplier_supplies_item` VALUES
(1,1,'2022-02-09 00:00:00',1200000),
(2,2,'2022-04-19 00:00:00',20000000),
(3,3,'2022-10-22 00:00:00',990000),
(4,4,'2022-12-06 00:00:00',6000000);
...
(1,'pickup',4000000000,1,'electronic device'),
(2,'tractor',500000000,2,'food stuffs'),
(3,'truck',2000000000,4,'dress');
...
INSERT INTO `warehouse_has_item` VALUES
(1,1,9,1),
(1,4,4,2),
(2,2,11,3),
(3,3,7,5);
